...
import com.example.tweetskeeper.ui.AddAnimation;
import com.example.tweetskeeper.ui.ColorSpinnerAdapter;
import com.example.tweetskeeper.ui.other.OtherBookmarkSpinnerAdapter;
import com.example.tweetskeeper.ui.twitter.TwitterBookmarkSpinnerAdapter;
...
public class MainActivity extends AppCompatActivity{
        ...
        try {
            ...
            if (status == null) { //
                ...
                for(int i = 0; i < mediaEntity.length; i++){
                    Log.e("Twitter Image", "" + mediaEntity[i].getMediaURL());
                }
            }
        } catch (
                TwitterException e) {
    ...
    private class addBookmarkAsyncTask extends AsyncTask<Void, Void, ArrayList<List>> {
        ...
        protected void onPostExecute(ArrayList<List> result){
            ...
            List<Color> tbUnusedColorList = result.get(0);
            List<Color> obUnusedColorList = result.get(1);

            mTwitterBookmarkColorAdapter.setColorList(tbUnusedColorList);
            mOtherBookmarkColorAdapter.setColorList(obUnusedColorList);
                ...
                public void onClick(View view) {
                    ...
                    switch (rgBookmarkType.getCheckedRadioButtonId()){
                        case R.id.rb_add_bookmark_twitter:
                            ...
                            twitterBookmark.setColor(tbUnusedColorList.get(colorSpinner.getSelectedItemPosition()).getId());
                        ...
                        case R.id.rb_add_bookmark_other:
                            ...
                            otherBookmark.setColor(obUnusedColorList.get(colorSpinner.getSelectedItemPosition()).getId());
